...
@section('page-title', 'تعديل المجال')
...
<div class="categories-page-banner admin-fade-in">
    <div class="categories-page-banner-content">
        ...
        <div>
            <h4>تعديل المجال: {{ $field->name }}</h4>
            <p>تحديث بيانات المجال وحالته</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.fields.update', $field) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="categories-switch-card">
                        <label class="form-check form-switch mb-0">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $field->is_active) ? 'checked' : '' }} class="form-check-input">
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4">{{ old('description', $field->description) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $field->slug) }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    @if($field->image)
                        <div class="category-form-image-preview mb-3">
                            <img src="{{ asset('storage/' . $field->image) }}" alt="{{ $field->image_alt ?: $field->name }}">
                        </div>
                    @endif
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('image_alt') is-invalid @enderror" id="image_alt" name="image_alt" value="{{ old('image_alt', $field->image_alt) }}" placeholder="وصف مختصر لصورة المجال">
