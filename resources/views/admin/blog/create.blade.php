...
@php
    ...
    $tempFeaturedImageUrl = $tempFeaturedImage ? asset('storage/' . $tempFeaturedImage) : null;
...
@section('content')
<div class="blogs-editor-page">
<!-- Page Banner -->
<div class="blogs-page-banner admin-fade-in">
    <div class="blogs-page-banner-content">
        <i class="fas fa-plus-circle"></i>
        <div>
            <h4>إنشاء مقال جديد</h4>
            <p>إضافة مقال أو تدوينة جديدة للموقع</p>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 blog-main-column">
                    ...
                    <div class="blog-field-group">
                        ...
                        {{-- External URL Field --}}
                        <div class="mt-3 {{ old('is_external') ? '' : 'd-none' }}" id="external_url_group">
                    ...
                    <div class="blog-sidebar-card">
                        ...
                        <div class="blog-sidebar-card-body">
                            <div class="blog-image-upload-area">
                                <div class="featured-image-preview mb-2 {{ $tempFeaturedImageUrl ? '' : 'd-none' }}">
                                    <img src="{{ $tempFeaturedImageUrl ?? '' }}" id="featured-image-preview" class="img-fluid rounded">
                                </div>
                        ...
                        <div class="blog-sidebar-card-body">
                            <div class="blog-toggle-card compact">
                                <label class="form-check form-switch mb-0">
                                    ...
                                    <span class="form-check-label">
                                        <strong>نشر فوري</strong>
                                    </span>
                                </label>
                            </div>
                            <div class="mt-3 {{ old('is_published', '1') ? 'd-none' : '' }}" id="publish_date_group">
                                <label for="published_at" class="form-label">تاريخ النشر المُجدول</label>
                        ...
                        <div class="blog-sidebar-card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_description" id="meta_description" rows="2"
                                    ...
                                    placeholder="وصف مختصر يظهر في نتائج البحث">{{ old('meta_description') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="meta_keywords" id="meta_keywords_hidden" value="{{ old('meta_keywords') }}">
                    ...
                    <div class="blog-sidebar-card">
                        ...
                        <div class="blog-sidebar-card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="blog_highlights" id="blog_highlights_hidden" value="{{ old('blog_highlights') }}">
                            ...
                            <div>
                                ...
                                <textarea name="contact_info" id="contact_info" rows="2"
                                    ...
                                    placeholder="اختياري: معلومات تواصل إضافية">{{ old('contact_info') }}</textarea>
                                @error('contact_info')
                                <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize external article field state
