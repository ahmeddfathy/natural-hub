...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const revealEls = document.querySelectorAll(
        '.value-card, .team-card, .journey-card, .rev-card, .sec-head, .story-img-wrap, .story-text, .milestone-card'
    );
    ...
    const milestoneItems = document.querySelectorAll('.milestone-card');
    let counted = false;
